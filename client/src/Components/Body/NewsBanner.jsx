  ...
  return (
    <div className='flex gap-2'>
        <div className='th-newsleft p-6 min-h-[100px]'>
            <h3 className='font-bold text-white text-2xl mb-4'>#What's happening ?</h3>

            <div className='p-3 text-[#025878] flex gap-3 mb-3 bg-white opacity-6 rounded-md'>
            ...
            <h3 className='font-bold text-white text-2xl my-4'>#Trending for you</h3>
            ...
            <h3 className='font-bold text-white text-2xl my-4'>#Upcoming Events</h3>
        ...
        <div  className='th-newsright p-2 flex flex-wrap justify-between'>
            {data.map((item) => {
                return (
                    <div className='pb-6 w-[30%] text-white'>
                        <img src={item.image} alt=""  className='rounded-md w-full'/>
                        <div className='flex gap-3 mt-2 flex-wrap'>
                            {item.tags.map((tag) => {
                             return <span className='bg-white px-4 text-xs  rounded-full flex items-start justify-center text-[#777]'>{tag.toUpperCase()}</span>
                            })}
                        </div>
